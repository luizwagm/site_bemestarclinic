...
#      mkdir -p ~/bin && cp ci/entregar.sh ~/bin/entregar-bemestar
#      chmod 755 ~/bin/entregar-bemestar
#
#  E no ~/.ssh/authorized_keys, a chave da entrega entra assim:
#      restrict,command="/home/deploy/bin/entregar-bemestar" ssh-ed25519 AAAA... entrega-bemestar
#
...
PROJETO="/var/www/projetos/BemEstarClinic"
TRAVA="/tmp/entregar-bemestar.lock"
...
logger -t entrega-bemestar "pedido de entrega de ${SSH_CLIENT%% *}"
...
logger -t entrega-bemestar "entrega terminou com código $CODIGO"
exit $CODIGO
